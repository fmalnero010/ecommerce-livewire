...
// source: phar:///var/www/html/vendor/phpstan/phpstan/phpstan.phar/conf/config.level10.neon
...
class Container_228ac43bd6 extends _PHPStan_f61439f6a\Nette\DI\Container
{
	protected $tags = [
		...
		return new PHPStan\Analyser\Ignore\IgnoredErrorHelper(
			...
			[
				[
					...
					'count' => 1,
					'path' => '/var/www/html/app/Http/Controllers/Auth/VerifyEmailController.php',
				],
				[
				...
				[
					...
					'count' => 1,
					'path' => '/var/www/html/app/Livewire/Actions/Logout.php',
				],
				[
					...
					'count' => 2,
					'path' => '/var/www/html/tests/Feature/Auth/AuthenticationTest.php',
				],
				[
				...
				[
					...
					'identifier' => 'property.notFound',
					'count' => 1,
					'path' => '/var/www/html/tests/Feature/Auth/EmailVerificationTest.php',
				],
				[
				...
				[
					...
					'identifier' => 'method.notFound',
					'count' => 3,
					'path' => '/var/www/html/tests/Feature/Auth/PasswordConfirmationTest.php',
				],
				[
					'message' => '#^Cannot call method assertRedirect\(\) on mixed\.$#',
					'identifier' => 'method.nonObject',
				...
				[
					...
					'identifier' => 'property.notFound',
					'count' => 4,
					'path' => '/var/www/html/tests/Feature/Auth/PasswordResetTest.php',
				],
				[
				...
				[
					...
					'identifier' => 'method.notFound',
					'count' => 1,
					'path' => '/var/www/html/tests/Feature/Auth/RegistrationTest.php',
				],
				[
					'message' => '#^Call to an undefined method PHPUnit\\\Framework\\\TestCase\:\:get\(\)\.$#',
					'identifier' => 'method.notFound',
				...
				[
					...
					'identifier' => 'method.notFound',
					'count' => 1,
					'path' => '/var/www/html/tests/Feature/DashboardTest.php',
				],
				[
					'message' => '#^Call to an undefined method PHPUnit\\\Framework\\\TestCase\:\:get\(\)\.$#',
					'identifier' => 'method.notFound',
				...
				[
					...
					'identifier' => 'method.notFound',
					'count' => 1,
					'path' => '/var/www/html/tests/Feature/ExampleTest.php',
				],
				[
					'message' => '#^Cannot call method assertStatus\(\) on mixed\.$#',
					'identifier' => 'method.nonObject',
				...
				[
					...
					'identifier' => 'method.notFound',
					'count' => 1,
					'path' => '/var/www/html/tests/Feature/Settings/PasswordUpdateTest.php',
				],
				[
					'message' => '#^Call to an undefined method PHPUnit\\\Framework\\\TestCase\:\:actingAs\(\)\.$#',
					'identifier' => 'method.notFound',
				...
				[
					...
					'identifier' => 'property.notFound',
					'count' => 2,
					'path' => '/var/www/html/tests/Feature/Settings/ProfileUpdateTest.php',
				],
				[
	...
	public function createService062(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_228ac43bd6 $container)
			{
	...
	public function createService086(): PHPStan\File\FileExcluderFactory
	{
		return new PHPStan\File\FileExcluderFactory(
			$this->getService('087'),
			[
				'analyseAndScan' => ['/var/www/html/vendor', '/var/www/html/storage', '/var/www/html/bootstrap/cache'],
				'analyse' => [],
			]
		);
	}
	...
	public function createServiceContainer(): Container_228ac43bd6
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'level' => 10,
			'paths' => ['/var/www/html/app', '/var/www/html/tests/Feature', '/var/www/html/tests/Unit'],
			'exceptions' => [
				'implicitThrows' => true,
			...
			'scanFiles' => ['/var/www/html/bootstrap/app.php'],
			'scanDirectories' => [],
			'parallel' => [
				'jobSize' => 20,
			...
			'env' => [
				...
				'PWD' => '/var/www/html',
				'TZ' => 'UTC',
				'IGNITION_LOCAL_SITES_PATH' => '/home/facu/proyectos/ecommerce-livewire',
				'LINES' => '30',
				'COLUMNS' => '120',
			],
		];
