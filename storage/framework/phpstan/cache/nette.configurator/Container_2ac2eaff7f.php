...
class Container_2ac2eaff7f extends _PHPStan_f61439f6a\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService062(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_2ac2eaff7f $container)
			{
	...
	public function createServiceContainer(): Container_2ac2eaff7f
	{
		return $this;
	}
